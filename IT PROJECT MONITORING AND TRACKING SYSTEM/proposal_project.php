...
$strSQL = "SELECT topic_project.*,  topic_project.Owner,topic_project.topic_topic,topic_project.advisergroup_id,advisergroup.group_id,topic_project.topic_years,topic_project.status,topic_project.group_number,topic_project.topic_keyword,topic_project.topic_abstrack,topic_project.topic_fieldstudy 
           FROM topic_project
            ...
            if ($result = $db->query($strSQL)) {
             ...
             ?>
                    <tr>
                      ...
                      <?php echo get_status_project($objResult->status); ?></td>
                      <td class="text-left" style="font-size: 16px;">
                      <?php echo get_member_list($objResult->group_id, 0, 45); ?></td>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"data-target="#show<?php echo $i; ?>">
                        <i class="fa fa-eye" title="Edit">View</i> </button>
                        <!-- Modal -->
                        <div class="modal fade" id="show<?php echo $i; ?>" tabindex="-1" role="dialog"aria-labelledby="myModalLabel" aria-hidden="true">
