...
$my_id = $_SESSION['id'];
     ...
     <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo get_member_list($row->group_id); ?>">
                                    </div>
                                </div>
                           ...
                           <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email" placeholder="Email" autocomplete="off" required aria-describedby="basic-addon1" value="<?php echo $row->member_email; ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-comments"></i>
                                             ...
                                             <textarea name="con" id="con" class="form-control" placeholder="Enter Comment" rows="5"></textarea>
