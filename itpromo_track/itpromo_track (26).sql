...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2020 at 09:32 PM
...
(1, 14, 1, 'Pass', 'Your Project is ok'),
(2, 33, 1, 'Pass', 'I think u have put more detail but overview is ok'),
(3, 45, 1, '', ''),
(4, 11, 3, '', ''),
(5, 29, 3, '', ''),
(6, 18, 3, '', ''),
...
(11, 19, 4, '', ''),
(12, 29, 4, '', ''),
(13, 18, 1, 'Pass', 'Your Project is Complete');
...
(1, '1580235506-Proposal.pdf', '', '', '1', 'Approve', 'Approve', '572431003 Nik-Husnee Nik-Uma572431029 Mout  Tylas', '3', 'Pass'),
(2, '1580235831-lastusecase.pdf', '', '', '3', 'Approve', 'Approve', '572431016 Sunee Kasem572431923 ilham', '2', ''),
(3, '1580235947-HousewaresRepairingWebapp.pdf', '', '', '2', 'Approve', 'Approve', '572431005 Nur-ida Che-loh66 Hunafah', '2', ''),
(4, '1580236289-personalassesment.pdf', '', '', '4', 'Approve', 'Approve', '572431011 Miskah Kasengteuba572431021 Afifah mamat', '3', 'Pass');
...
(3, 572431009, 'Han', 'Norihan Ha', '1234', 'Student', '0747346826', 'han@gmail.com', 'Female', 1, NULL),
...
(1, 'Presentation', '1', 'IT-123', '22:50:00', '2020-01-28', 'Proposal Presentation', 12, 1),
(2, 'Presentation', '1', 'IT-231', '21:53:00', '2020-02-28', 'Proposal Presentation', 12, 2),
(3, 'Presentation', '1', 'IT-321', '19:53:00', '2020-01-28', 'Proposal Presentation', 12, 3),
(4, 'Presentation', '1', 'IT-432', '21:54:00', '2020-01-28', 'Proposal Presentation', 12, 4);
...
--
ALTER TABLE `committeegroup`
  MODIFY `committeegroup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
