...
<!-- partial:index.partial.html -->
 ...
 <a href="../form04/pf04.php?id=<?php echo $objResult->advisergroup_id;?>" class="form-wizard-next-btn float-left">Previous</a>

                <a href="../form06/pf06.php?id=<?php echo $objResult->advisergroup_id;?>" class="form-wizard-next-btn float-right">Next</a>
