     ...
     if($result = $db->query($strSQL)){
           ...
           <h6><small class="text-muted">Approval Letter Agreed to Sign By Advisor</small>
              ...
              <div class="form-group clearfix">
                 ...
                 <a href="../form08/pf08.php?id=<?php echo $objResult->advisergroup_id;?>" class="form-wizard-next-btn float-left">Previous</a>

                <a href="../form10/pf10.php?id=<?php echo $objResult->advisergroup_id;?>" class="form-wizard-next-btn float-right">Next</a>
