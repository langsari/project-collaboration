...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2020 at 07:38 PM
...
(27, 'Hi u are Graduate', '2020-03-16 18:27:22', 'Nik-Husnee Nik-Uma', 1, 1, '11'),
(28, 'Thanks', '2020-03-16 18:29:16', 'Kholed Langsaree', 0, 1, '11');
...
CREATE TABLE `files` (
  ...
  `by_advisor11` enum('','Waiting','Pass','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Waiting',
...
INSERT INTO `files` (`files_id`, `Owner`, `files_filename_proposal`, `files_filename_project`, `complete_project`, `advisergroup_id`, `head_of_depart`, `dean`, `pf`, `files_status`, `by_officer`, `status_advisor`, `by_advisor04`, `by_officer05`, `by_advisor06`, `by_advisor07`, `by_advisor08`, `by_officer09`, `by_advisor10`, `by_advisor11`, `by_advisor12`, `by_officer13`) VALUES
(1, '572431003 Nik-Husnee Nik-Uma572431029 Mout  Tylas', 'โครงสร้างรายวิชา-หน่วยย่อยและแผน.pdf', '1578820332-1577847623-i.pdf', 'conclusion.pdf', '1', '', '', '13', 'Approve', 'Approve', 'Pass', 'Pass', 'Pass', 'Pass', 'Pass', 'Pass', 'Approve', 'Pass', 'Pass', 'Pass', 'Pass'),
(2, '66 Hunafah572431005 Nur-ida', 'last use case (1).pdf', '', '', '2', '', '', '3', 'Approve', 'Approve', 'Pass', '', '', '', '', '', '', '', '', '', ''),
(3, '572431016 Sunee Kasem572431923 ilham', 'Housewares Repairing Webapp.pdf', '', '', '4', '', '', '2', 'Approve', 'Approve', '', '', '', '', '', '', '', '', '', '', '');
...
(11, 1001, 'husna', 'Nurulhusna Abdulaziz', '1234', 'Lecturer', '0856375367', 'husna@gmail.com', 'Female', '', '', 0, 0, '', '', '', '', 1, NULL),
