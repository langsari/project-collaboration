...
<?php if( $objResult->files_filename_proposal != ""){ ?>
 ...
 <?php }else{?>
            ...
            <div class="form-group clearfix">
                  ...
                  <a href="../form02/pf02.php?id=<?php echo $objResult->advisergroup_id;?>" class="form-wizard-next-btn float-left">Previous</a>

                <a href="../form04/pf04.php?id=<?php echo $objResult->advisergroup_id;?>" class="form-wizard-next-btn float-right">Next</a>
