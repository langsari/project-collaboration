...
<head>
  ...
  <title>ITPROMO&TRACK |Register</title>
...
<form id="add" name="add" method="post" action="checkregis.php"
                                onsubmit="return checkForm()">      
                                  <div class="input-group mb-3">
 <input type="text" class="form-control"
                                             aria-describedby="basic-addon1" id="member_idcard" name="member_idcard"
                                               placeholder="Example: 572431003"   autocomplete="off" required aria-describedby="basic-addon1" onkeypress='validate(event)'  maxlength="9" >          <div class="input-group-append">
 ...
 <input type="text" class="form-control" placeholder="Example: Naemah "  
                                                id="member_username" name="member_username"  autocomplete="off" required aria-describedby="basic-addon1">          <div class="input-group-append">
            <div class="input-group-text">
...
pattern="^[a-zA-Z0-9]+@gmail\.com$" required
     ...
     <div class="input-group mb-3">
                                            ...
                                            &nbsp;&nbsp; &nbsp;&nbsp; <label class="radio-inline"><input type="radio"
                                                ...
                                                &nbsp;&nbsp; Female</label>  <div class="input-group-append">
