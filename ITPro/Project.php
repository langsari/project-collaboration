      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
            <i class="fa fa-fw fa-sign-out"></i>username Logout</a>
        </li>
      </ul>
    </div>
  </nav>
...
<h1> Thesis</h1>
 ...
 <div class="form-group">
       ...
       <div class="form-group">
           ...
           <div class="form-group">
            <label for="name ">Advisor1:</label>
            <input type="text" name="name" class="form-control">
          </div>
           <div class="form-group">
            <label for="name ">Date of Thesis Examination:</label>
            <input type="text" name="name" class="form-control">
          </div>
           <div class="form-group">
            <label for="name ">Test Hours:</label>
            <input type="text" name="name" class="form-control">
          </div>
           <div class="form-group">
       ...
       <div class="form-group">
            <label for="name ">Status Thesis</label>
            <input type="text" name="name" class="form-control">
          </div>
        ...
        <center>  <input type="submit" name="submit" class="btn btn-cancel" value="Submit">
