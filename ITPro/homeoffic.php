  ...
  <table class="table table-hover">
    ...
    <tbody>
      <tr>
        <td>1</td>
        <td>ITpromo</td>
        <td>Nik-Husnee&Tylas</td>
        <td>02-02-61</td>
        <td><button>view</button><button>delete</button><button>status</button></td>
        <td>(✔)</td>
      </tr>
      <tr>
        <td>2</td>
        <td>Smart range hood </td>
        <td>Nur-ida&Hunafah</td>
        <td>05-01-61</td>
       <td><button>view</button><button>delete</button><button>status</button></td>
         <td>(X)</td>
    </tbody>
