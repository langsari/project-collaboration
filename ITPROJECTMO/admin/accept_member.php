    ...
    while ($objResult = $result->fetch_object()) {
        ?>
                    <tr>
                      ...
                      <td class="text-left" style="font-size: 15px;"><?php echo position($objResult->member_pos); ?>
                      </td>
                      ...
                      <td>
                        ...
                        <a href="../admin/accept.php?id=<?php echo $objResult->member_id; ?>"
                          class="btn btn-primary btn-sm">
                          <i class="fa fa-edit" title="Detail"></i></a>


                        <a href="delete_approve.php?id=<?php echo $objResult->member_id; ?>"
                          class="btn btn-danger btn-sm" onclick="return confirm('Are You sure Delete?')">
            ...
            <form id="add" name="add" method="post" action="../admin/check_accept_member.php"
              ...
              <div class="user-details">
                <div class="input-group mb-3">
                  <input type="text" class="form-control" id="member_idcard" name="member_idcard" placeholder="UserID"
                    autocomplete="off" required aria-describedby="basic-addon1" onkeypress='validate(event)'
                    maxlength="9">
                ...
                <div class="input-group mb-3">
                  <input type="text" class="form-control" placeholder="Username" id="member_username"
                ...
                <div class="input-group mb-3">
                  <input type="text" class="form-control" id="member_fullname" name="member_fullname"
                    placeholder="Full name" autocomplete="off" required aria-describedby="basic-addon1">
                  <div class="input-group-append">
                    <div class="input-group-text">
                      <span class="fas fa-user"></span>
                    </div>
                ...
                <div class="input-group mb-3">
                  <input type="password" class="form-control" placeholder="Password" name="member_password"
                    id="member_password" onKeyUp="passwordStrength(this.value)" class="form-control" autocomplete="off"
                ...
                <center>
                  <div class="input-group">
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="member_gender" value="Male" required aria-describedby="basic-addon1">
                      &nbsp;&nbsp; Male</label>&nbsp;&nbsp; &nbsp;&nbsp;
                    <label class="radio-inline"><input type="radio" name="member_gender" value="Female"
