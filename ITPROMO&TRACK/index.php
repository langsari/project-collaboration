...
<head>
  ...
  <link rel="stylesheet" href="dist/lib/css/jquery.dataTables.min.css">
  <!-- /PAGE LEVEL STYLESHEETS -->
  ...
  <link rel="stylesheet" href="dist/lib/css/chartist.min.css">
  ...
  <script type="text/javascript" src="dist/lib/js/chartist.min.js"></script>
  ...
  <script type="text/javascript" src="dist/assets/js/pages_datatables.min.js"></script>
...
<body>
  ...
  <nav class="navbar navbar-toggleable-md">
    ...
    <a class="navbar-brand logo" href="?page=homepage">
      <img src="dist/assets/img/lo.png">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link dropdown-toggle dropdown-has-after" href="http://example.com" id="navbarDropdownMenuLink"
      ...
      <div id="sidebar-main" class="sidebar sidebar-default">
        <div class="sidebar-content">
          <ul class="navigation">
            ...
            <!-- Tylas ทำ-->
            <li><a class="app-menu__item active" href="?page=Annoucement"><i class="fa fa-bullhorn"></i><span
                  class="app-menu__label">Announcements</span></a></li>

            <!-- ยังไม่ทำน่ะ.....ทำแค่เปลี่ยน icon-->
            <li><a class="app-menu__item " href="?page=show_topic"><i class="fa fa-file"></i><span
                  class="app-menu__label">Topics</span></a></li>
            ...
            <li><a class="app-menu__item " href="?page=proposal_project"> <i class="fa fa-book"></i><span
                  class="app-menu__label">Proposal Project</span></a></li>
            <!-- Nik ทำ-->
            <li><a class="app-menu__item " href="?page=guide"><i class="fa fa-glide-g"></i><span
                  class="app-menu__label">Guide</span></a></li>

            <li><a class="app-menu__item " href="?page=schedule"><i class="fa fa-calendar"></i><span
                  class="app-menu__label">Schedule</span></a></li>

            <li><a class="app-menu__item " href="?page=form"><i class='fa fa-edit'></i><span
                  class="app-menu__label">Forms</span></a></li>

            <li><a class="app-menu__item " href="?page=booked"><i class='fa fa-book'></i><span
                  class="app-menu__label">Booked</span></a></li>
