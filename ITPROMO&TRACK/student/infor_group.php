   ...
   <div class="content">
     ...
     <div class="row">
                   ...
                   <div class="modal-body">
                     ...
                     <form class="form" method="post" action="student/check_newgroup.php">
                       <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                         data-target="#joinpartner" style="margin-bottom: 13px;">
                         <i class="glyphicon glyphicon-plus"></i>Join Partner
                       </button>
                       <p>
                         <label>Create Group</label>
                         <input class="form-control" type="text" name="group_number" id="group_number"
               ...
               <div class="modal-dialog" role="document">
                 <div class="modal-content">
                   <div class="modal-header">
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                         aria-hidden="true">&times;</span></button>
                     <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-plus"></i>Join your partner
                     </h4>
                   </div>
                   <div class="modal-body">

                     <form id="add" name="add" method="post" action="student/check_join.php"
              ...
              ?>
                         ...
                         <tr>
                           ...
                           <td class="text-center">
                             <a href="student/check_group.php?id=<?php echo $row->group_id; ?>"
                               class="btn btn-primary btn-xs" onclick="return confirm_joingroup()"><i
                                 class="glyphicon glyphicon-plus-sign"></i> Join this Group</a>
                           </td>
                         </tr>
                         <?php
                }
       ...
       <div class="col-lg-6">
         <div class="card">
           <div class="card-block">
             <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#selectadvisor"
               style="margin-bottom: 13px;">
               ...
               <div class="modal-dialog" role="document">
                 <div class="modal-content">
                   <div class="modal-header">
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                         aria-hidden="true">&times;</span></button>
                     <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-plus"></i>Select your
                       advisor</h4>
                   </div>
                   <div class="modal-body">

                     <form id="add" name="add" method="post" action="student/check_selectadvisor.php"
                       onsubmit="return checkForm()">
                ...
                ?>
                       ...
                       <div class="form-group row">
                         ...
                         <div class="col-md-9">
                           <input type="text" class="form-control" id="advisergroup_topic" name="advisergroup_topic"
                             placeholder="project topic name" autocomplete="off" aria-describedby="basic-addon1">
                         </div>
                       </div>
              ...
              ?>
                 <tr>
                   ...
                   <td class="text-center"><span
                       class="badge badge-success"><?php echo $row->advisergroup_status;?></span>
