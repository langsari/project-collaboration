              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-plus"></i> Add New
                      Annoucement</h4>
                  </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#view"
                      onclick="view_annouce(<?php echo $objResult->announcement_id; ?>)"><i
              ...
              <form action="#">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    ...
                    <textarea class="form-control" rows="10" name="announcement_detail1" id="announcement_detail1"
                      required></textarea>
                  </div>
                </div>
