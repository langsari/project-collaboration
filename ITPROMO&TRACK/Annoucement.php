            ...
            <table class="display datatable table table-stripped" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <td>
                    ...
                    <font color="blue" size="5"> <?php echo $objResult->announcement_topic; ?> </font> </br>
                  </b>
                  ...
                  </br><i class='far fa-calendar-alt' style='font-size:20px'> </i>&nbsp;&nbsp;&nbsp;
                  <?php echo $objResult->announcement_date; ?> </br>
                  ...
                  <div class="col-md-12" align="right">
                    ...
                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editPS"
                      onclick="edit_ps(<?php echo $objResult->announcement_id; ?>)"><i class="fa fa-eye"></i>Read
                      more</button>
              ...
              <form action="#">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    ...
                    <textarea class="form-control" rows="10" name="announcement_detail" id="announcement_detail"
                      required></textarea>
