...
<div class="content">
    ...
    $strSQL = "SELECT advisergroup.*,  advisergroup.group_id,committeegroup.comment,committeegroup.member_id,member.member_fullname FROM advisergroup
          LEFT JOIN committeegroup ON advisergroup.group_id = committeegroup.group_id
        LEFT JOIN member ON advisergroup.member_id = member.member_id 
   ...
   ?>
            ...
            <table class="display datatable table table-stripped" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    &nbsp;&nbsp; <?php echo $objResult->member_id;?> </br>

                    &nbsp;&nbsp; <?php echo $objResult->comment;?></br>
