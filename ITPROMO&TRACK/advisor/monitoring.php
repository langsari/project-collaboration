...
//กรณีมี Error เกิดขึ้น
	if ($mysqli->connect_error) {
		...
		$get_data = $mysqli->query("SELECT * FROM files");
			...
			<tbody>
				<?php
					foreach($result as $result_tb){
						echo"<tr>";
							echo "<td>".$result_tb['advisergroup_id']."</td>";
							echo "<td>".$result_tb['files_status']."</td>";
							echo "<td>".$result_tb['member_id']."</td>";
