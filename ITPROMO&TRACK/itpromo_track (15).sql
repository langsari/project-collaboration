...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2020 at 05:25 PM
...
CREATE TABLE `files` (
  ...
  `advisergroup_id` int(20) NOT NULL,
  `files_status` enum('Waiting','Approve') COLLATE utf8_unicode_ci NOT NULL COMMENT 'w: wait to accept,1: pass,4:officer approved',
...
(1, '1577973082-lastusecase.pdf', '', 1, 'Approve', 'Approve'),
(3, '1578001221-Dua-in-the-life.pdf', '', 18, 'Waiting', ''),
(5, '1578218059-LAMPIRAN-BADANLAPORANUTKFEP.pdf', '', 17, 'Waiting', ''),
(6, '1578219411-LAMPIRAN-BADANLAPORANUTKFSK.pdf', '', 16, 'Waiting', ''),
(8, '1578240999-1577973082-lastusecase(2).pdf', '', 20, 'Approve', 'Approve');
