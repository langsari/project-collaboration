              ...
              <div class="card-body p-0">
                <main role="main" class="container">
                  <h4 class="mt-3">Requirement Fulfillment </br>
                    <small class="text-muted">This is explanation steps of the <a href="?page=guide"
                        class="btn-primary btn-sm">Guide/Process</a> of requirement fulfilment after project
                      presentation</small>
                  </h4>
                  <hr>
                  <h5>Please continues and follow these step and fulfill requirements below;</h5>
                  <ul>
                    <li>Step: Project Revision(PF10), the student must complete revision and get all signatures from
                      Advisor(s) and three(3) Committees.</li>
                    <li>Step: Project Approve(PF11), the form will insert and attach to after cover of the Project Book
                    </li>
                    ...
                    <li>Step: Project Approve(PF11) have to sign by (1) Adviser(s), (2) Committees, (3) Head of
                      Department and (4) Dean of Faculty. This must completed by the student self.</li>
                    <li>Step: Submit complete project document and related resources to Adviser, to get Free From
                      Advisor(PF12).</li>
                    <li>Step: Submit complete project document and related resources, and PF10, PF11, and PF12 to
                      officer.</li>
                  </ul>
                  <hr>
                  ...
                  <p>
                    <strong>Requirement submission SOFT COPY, please provide in CD, DVD, Flash Disk or other media with
                      file naming as below:</strong>
                  </p>
                  <ul>
                    ...
                    <li>Zip all files above and naming as Student_ID-name-Graduate example:
                      491431002-Kholed-Langsari-Graduate.zip</li>
                  </ul>
                  <hr>
                  ...
                  <p>The journal or paper format should follow <a
                      href="https://www.ieee.org/content/dam/ieee-org/ieee/web/org/conferences/Conference-template-A4.doc">IEEE</a>
                    or <a href="https://www.elsevier.com/__data/promis_misc/FINE_FinalTemplate.doc">ScienceDirect</a>
                    standard</p>
                  <hr>
                  <h5>Submission</h5>
                  <p>For requirement submission above, please submit directly to IT officer, before dateline as
                    mentioned in the schedule</p>
                  <hr>
                  <br>
                </main>
              </div>
