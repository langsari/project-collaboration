             ...
             <table class="display datatable table table-stripped" cellspacing="0" width="100%">
               ...
               <tbody>
                 ...
                 <td>
                     ...
                     <font color="blue" size="5"> <?php echo $objResult->news_topic; ?> </font> </br>
                   </b>
                   ...
                   <?php echo $objResult->news_date; ?> </br>
                   ...
                   <div class="col-md-12" align="right">
                     <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editPS"
                       onclick="edit_ps(<?php echo $objResult->news_id; ?>)"><i class="fa fa-eye"></i>Read more</button>
