              ...
              <div class="card">
                <div class="card-block">
                  ...
                  <div class="button" align="right">
                    ...
                    <button> <a href="?page=pf1&id=<?php echo $objResult->advisergroup_id;?>" type="button" class="btn previous">Previous</button></a>
                    <button> <a href="?page=pf3&id=<?php echo $objResult->advisergroup_id;?>"  type="button" class="btn next">Next</button></a>
                  </div>
            </fieldset>
            <?php
                 } }
