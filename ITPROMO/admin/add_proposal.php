            ...
            <tr>
                    <td><?php echo $objResult["id"];?></td>
                      ...
                      <td><?php echo $objResult["topic_years"];?></td>
                       <td><?php echo $objResult["writer"];?></td>
                            ...
                            <div class="user-details">
                                <div class="form-group">
                                    <div class="input-group">
                                      Topic  <input type="text" class="form-control" placeholder="Topic" aria-describedby="basic-addon1" id="news_topic" name="news_topic" autocomplete="off" required>
                                    </div>
                                </div>
                                                  ...
                                                  <div class="form-group">
                                    <div class="input-group">col-form-label">ID Card Student</label>
                                                    </div>
                                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="id" name="id"placeholder="ID Student" autocomplete="off" required aria-describedby="basic-addon1">
                                                    </div>
