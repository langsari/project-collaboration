...
<head>
  ...
  <title>ITPROMOT |Proposal Schedule </title>
...
$sql = "SELECT schedule.*, partnergroup.group_id,partnergroup.group_number,member.member_fullname,schedule.writer,schedule.group_id,advisergroup.group_id,advisergroup.advisergroup_topic,schedule.schedule_id,topic_project.Owner,topic_project.topic_topic FROM schedule
        ...
        ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="delete_schedule_proposal.php?id=<?php echo $objResult->schedule_id; ?>"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form id="add" name="add" method="post" action="../admin/check_schedule_proposal.php"
