...
?>
 ...
 <div class="container-fluid">
  ...
  <div class="comment-form">
    ...
    <form method="post" action="check_comment05.php" class="form" name="form" ng-submit="form.$valid && cmntCtrl.addComment()" >
...
?>
          ...
          <input type="hidden" name="form_pf" id="form_pf"  value="5" />
